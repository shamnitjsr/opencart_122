...
public class TC006_EndToEntTest extends BaseClass {
	...
	public void endToendTest() throws InterruptedException {
		...
		regpage.setConfirmPassowrd("test123");
		...
		if (sp.isProductExits(p.getProperty("searchProductName"))) {
		...
		Thread.sleep(1000);
		ch.setcity("Bangalore");
		Thread.sleep(1000);
		ch.setpin("803202");
		Thread.sleep(1000);
		ch.setCountry("India");
		Thread.sleep(1000);
		ch.setState("Karnataka");
		Thread.sleep(1000);
